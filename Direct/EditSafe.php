...
$sql = "SELECT * FROM `Direct` WHERE ID =".$id;
...
display:none;">
  	...
  	<div class="row ">
  		...
  		<div class="col-lg-7">
           ...
           <img src=<?php echo '"https://dordevoi.ro/Direct/uploads/'.$id.'.jpg"'; ?> style="height: 350px;" onerror="altimg()" id="SafeIMG" class="img-thumbnail">
    ...
    document.getElementById("SafeIMG").src = "https://dordevoi.ro/MyProfile/logo.png"
           ...
           <h1 ><i><strong><?php echo $safe["Name"]; ?></strong></i></h1> <!-- 
...
-->
    ...
    <li class="active upjump"><a data-toggle="tab" href="#home"><button type="button"style="background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden;
    outline:none;"><h1> <span class="glyphicon glyphicon-pencil"></span></h1><br><h3>Mesaj Text</h3></button></a></li>

    <li class="upjump"><a data-toggle="tab" href="#menu1"><button type="button"style="background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden;
    outline:none;"><h1> <span class="glyphicon glyphicon-picture"></span></h1><br><h3>Imagine Noua</h3></button></a></li>

    <li class="upjump"><a data-toggle="tab" href="#menu2"><button type="button"style="background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden;
    outline:none;"><h1> <span class="glyphicon glyphicon-film"></span></h1><br><h3>Video Nou</h3></button></a></li>

    <li class="upjump"><a data-toggle="tab" href="#menu5"><button type="button"style="background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden;
    ...
    <li class="upjump"><a data-toggle="tab" href="#menu3"><button type="button"style="background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden;
    outline:none;"><h1> <span class="glyphicon glyphicon-music"></span></h1><br><h3>Audio Nou</h3></button></a></li>

    <li class="upjump"><a data-toggle="tab" href="#menu4"><button type="button"style="background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden;
    outline:none;"><h1> <span class="glyphicon glyphicon-file"></span></h1><br><h3>Document Nou</h3></button></a></li>
    
    <li class="upjump"><a href="https://dordevoi.ro/MyProfile/Store.php"><button type="button"style="background-color: Transparent;
    background-repeat:no-repeat;
    border: none;
    cursor:pointer;
    overflow: hidden;
    outline:none;"><h1> <span class="glyphicon glyphicon-gift"></span></h1><br><h3>Trimite Cadou</h3></button></a></li>
  ...
  <div class="tab-content">
    ...
    <form action="https://dordevoi.ro/Direct/Assets/Text/AddText.php" method="POST"  target="_blank">    
    ...
    <div id="menu1" class="tab-pane fade">
      ...
      <form action="https://dordevoi.ro/Direct/Assets/Images/ImageUpload.php" method="POST" enctype="multipart/form-data"  target="_blank">
 ...
 <center><img id="blah" src="https://www.dordevoi.ro/Placeholder.png"  alt="your image" style="width:80%;
  ...
  <div class="form-group">
    ...
    <div id="menu2" class="tab-pane fade">
      ...
      <form action="https://dordevoi.ro/Direct/Assets/Videos/VideoUpload.php" method="Post" enctype="multipart/form-data"  target="_blank">
		...
		<div class="input-group image-preview">
                ...
                <span class="input-group-btn">
                    ...
                    <div class="btn btn-default image-preview-input">
                        ...
                        <input type="file" accept=".mp4" name="file"/> <!-- rename it -->
...
if (result) {
    ...
    <h3>Puteti adauga fisiere in format mp3 si wav</h3>
       ...
       <form action="https://dordevoi.ro/Direct/Assets/Audio/AddAudio.php" method="Post" enctype="multipart/form-data"  target="_blank" >
			...
			<div class="input-group image-preview">
                ...
                <span class="input-group-btn">
                    ...
                    <div class="btn btn-default image-preview-input">
                        ...
                        <input type="file" accept=".mp3, .wav" name="file"/> <!-- rename it -->
  ...
  <div id="menu4" class="tab-pane fade">
    ...
    <h3>Only doc/docx, ppt, xls and PDF supported</h3>
       ...
       <form action="https://dordevoi.ro/Direct/Assets/Documents/DocumentUpload.php" method="Post" enctype="multipart/form-data"  target="_blank" >
...
<div class="row">
    ...
    <h1>
         ...
         Va rugam sa impartasiti aceste mesaje cu cei dragi  sau sa   creati un cadou personalizat cu o poza sau un text drag dumneavoastra  
...
<script>
 ...
 <button type="button" class="btn btn-info btn-lg" onclick="refreshTimeline()" ><span class="glyphicon glyphicon-refresh
"></span></button>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>De aici puteti edita datele mesajului</p>
                <form action="editdate.php" method="POST">
                  ...
                  <input type="text" style="display:none" value="<?php echo $safe["ID"]; ?>" name="SafeID">
