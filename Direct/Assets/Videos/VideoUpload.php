...
$sql = 'INSERT INTO `Direct_Assets`(`Type`, `Message`, `Date_Available`, `SafeID`) VALUES ("Video","'.$comment.'","'.$date.'","'.$id.'")';
...
&& in_array($extension, $allowedExts))
  ...
  echo "Invalid file";
   ...
   $conn->query("UPDATE `Direct_Assets` SET `Media_URL` = 'https://dordevoi.ro/Direct/Assets/Videos/upload/".$last_id.".".pathinfo($_FILES['file']['name'], PATHINFO_EXTENSION)."',`VideoType`='".pathinfo($_FILES['file']['name'], PATHINFO_EXTENSION)."' WHERE `Direct_Assets`.`Asset_ID` =".$last_id);
