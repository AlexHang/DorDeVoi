...
header('Location: http://www.dordevoi.ro/facebooklog.php');
...
$loginUrl = $helper->getLoginUrl('http://www.dordevoi.ro/facebooklog.php', $permissions);
...
if(isset($fbid))
{echo '<a href="https://dordevoi.ro/MyProfile/Profile.php">Continua</a>';
// Create connection
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo '
        <form id="f1" action="https://dordevoi.ro/MyProfile/Profile.php" method="Post">
