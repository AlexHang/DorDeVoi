...
display:none;">
    ...
    document.getElementById("SafeIMG").src = "https://dordevoi.ro/MyProfile/logo.png"
           ...
           <h1 ><i><strong><?php echo $safe["Reciever"]; ?></strong></i></h1>
            <p>Acestea sunt datele de a intra in mesajul criptat creat de dumneavoastra . Va rugam sa impartasiti aceste date doar cu persoana careia doriti sa ii trimiteti mesajul sau creati un <a href="https://dordevoi.ro/MyProfile/Store.php">cadou</a> cu aceste date.</p>
           <h2 style="color:#337ab7"><i>Safe ID:<font style="color:black;"> <?php echo $safe["SafeID"]; ?></font></i></h2>
           <h2 style="color:#337ab7"><i>Cheie Acces: <font style="color:black;"><?php echo $safe["Access_Key"]; ?></font></i></h2>
...
"></span></button>
 <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" >Modifica datele acestui mesaj</button>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">De aici puteti edita datele mesajului</h4>
      </div>
      <div class="modal-body">
        <p></p>
                <form action="editdate.php" method="POST">
                  ...
                  <center><button type="submit" class="btn btn-default">Salveaza</button></center>
                </form>
      </div>
      <div class="modal-footer">
