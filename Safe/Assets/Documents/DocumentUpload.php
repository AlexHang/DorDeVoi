...
$sql = 'INSERT INTO `Assets`(`Type`, `Message`, `Date_Available`, `SafeID`) VALUES ("Document","'.$comment.'","'.$date.'","'.$id.'")';
...
&& in_array($extension, $allowedExts))
  ...
  echo "Invalid file";
   ...
   $conn->query("UPDATE `Assets` SET `Media_URL` = 'https://dordevoi.ro/Safe/Assets/Documents/upload/".$last_id.".".pathinfo($_FILES['file']['name'], PATHINFO_EXTENSION)."',`VideoType`='".pathinfo($_FILES['file']['name'], PATHINFO_EXTENSION)."' WHERE `Assets`.`Asset_ID` =".$last_id);
