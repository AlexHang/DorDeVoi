...
<video "isAnythingPlaying=1;" onpause="isAnythingPlaying=0;" id="vid'.$row["Media_URL"].'" class="embed-responsive-item" controls  > 
...
<video "isAnythingPlaying=1;" onpause="isAnythingPlaying=0;" class="embed-responsive-item" controls  poster="https://dordevoi.ro/MyProfile/logo.png"> 
...
<source src="'.$row["Media_URL"].'" type="video/mp4">
...

            {
                ...
                echo '<audio "isAnythingPlaying=1;" onpause="isAnythingPlaying=0;" controls >';
