...
<form class="centru" action="Create_Safe.php" method="post" id="form1" enctype="multipart/form-data">
...
{   /*
    ...
    <div class="form-group">
        <center><input class="btn btn-success" type="submit" value="Creeaza un Safe nou"></center>
    </div>
         </div>
 </form>
  </div>
