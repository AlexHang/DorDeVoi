              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  <div class="modal-header" style="background-color:#428bca;">
                    ...
                    <h3 class="modal-title"><a href="https://www.dordevoi.ro"><img src="logo.png"></a></h3>
                  </div>
                  <div class="modal-body">
                    <h4>Va rugam sa va verificati email-ul, si sa urmati pasii din mesajul pe care vi l-am trimis, pentru a va activa contul Dor De Voi</h4>
                  </div>
                  <div class="modal-footer"  style="background-color:#428bca;">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><h4 style="color:black">Am inteles</h4></button>
                  </div>
                </div>
